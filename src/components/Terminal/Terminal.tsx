...
export default function Terminal() {
  ...
  const updateIframeUrl = () => {
    ...
    setIframeUrl(`${currentProtocol}//${currentHost}:1337/ssh/host/${currentHost}?${Math.random()}`);
    console.log(`${currentProtocol}//${currentHost}:1337/ssh/host/${currentHost}?${Math.random()}`)
  };
